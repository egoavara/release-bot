...
export class ApmServerList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:apm.k8s.elastic.co/v1alpha1:ApmServerList';
     ...
     */
    public readonly apiVersion!: pulumi.Output<"apm.k8s.elastic.co/v1alpha1">;
    /**
     * List of apmservers. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
     */
    public readonly items!: pulumi.Output<outputs.apm.v1alpha1.ApmServer[]>;
    /**
