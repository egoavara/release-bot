...
export class Elasticsearch extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.elasticsearch.v1.ElasticsearchSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.elasticsearch.v1.ElasticsearchStatus>;
    ...
    constructor(name: string, args?: ElasticsearchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:elasticsearch.k8s.elastic.co/v1alpha1:Elasticsearch" }, { type: "kubernetes:elasticsearch.k8s.elastic.co/v1beta1:Elasticsearch" }] };
