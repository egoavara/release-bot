...
export class ElasticsearchList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:elasticsearch.k8s.elastic.co/v1:ElasticsearchList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.elasticsearch.v1.Elasticsearch[]>;
    /**
