...
export class Elasticsearch extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: ElasticsearchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:elasticsearch.k8s.elastic.co/v1:Elasticsearch" }, { type: "kubernetes:elasticsearch.k8s.elastic.co/v1beta1:Elasticsearch" }] };
