...
export class Elasticsearch extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.elasticsearch.v1beta1.ElasticsearchSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.elasticsearch.v1beta1.ElasticsearchStatus>;
