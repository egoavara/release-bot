...
export class Kibana extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.kibana.v1.KibanaSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.kibana.v1.KibanaStatus>;
    ...
    constructor(name: string, args?: KibanaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:kibana.k8s.elastic.co/v1alpha1:Kibana" }, { type: "kubernetes:kibana.k8s.elastic.co/v1beta1:Kibana" }] };
