...
export class KibanaList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:kibana.k8s.elastic.co/v1alpha1:KibanaList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.kibana.v1alpha1.Kibana[]>;
    /**
