...
export class KibanaPatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:kibana.k8s.elastic.co/v1alpha1:KibanaPatch';
    ...
    constructor(name: string, args?: KibanaPatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:kibana.k8s.elastic.co/v1:KibanaPatch" }, { type: "kubernetes:kibana.k8s.elastic.co/v1beta1:KibanaPatch" }] };
