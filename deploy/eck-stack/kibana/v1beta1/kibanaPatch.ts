...
export class KibanaPatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:kibana.k8s.elastic.co/v1beta1:KibanaPatch';
    ...
    public readonly spec!: pulumi.Output<outputs.kibana.v1beta1.KibanaSpecPatch>;
    public /*out*/ readonly status!: pulumi.Output<outputs.kibana.v1beta1.KibanaStatusPatch>;
...
export interface KibanaPatchArgs {
    ...
    spec?: pulumi.Input<inputs.kibana.v1beta1.KibanaSpecPatch>;
}
