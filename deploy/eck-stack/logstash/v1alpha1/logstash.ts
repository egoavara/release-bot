...
export class Logstash extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Logstash {
        return new Logstash(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:logstash.k8s.elastic.co/v1alpha1:Logstash';
    ...
    public readonly spec!: pulumi.Output<outputs.logstash.v1alpha1.LogstashSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.logstash.v1alpha1.LogstashStatus>;
