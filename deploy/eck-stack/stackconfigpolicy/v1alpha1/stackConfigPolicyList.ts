 ...
 */
export class StackConfigPolicyList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StackConfigPolicyList {
        return new StackConfigPolicyList(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:stackconfigpolicy.k8s.elastic.co/v1alpha1:StackConfigPolicyList';

    /**
     * Returns true if the given object is an instance of StackConfigPolicyList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is StackConfigPolicyList {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === StackConfigPolicyList.__pulumiType;
    }
     ...
     */
    public readonly items!: pulumi.Output<outputs.stackconfigpolicy.v1alpha1.StackConfigPolicy[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    public readonly kind!: pulumi.Output<"StackConfigPolicyList">;
    /**
    ...
    constructor(name: string, args?: StackConfigPolicyListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "StackConfigPolicyList";
        ...
        super(StackConfigPolicyList.__pulumiType, name, resourceInputs, opts);
    }
}
