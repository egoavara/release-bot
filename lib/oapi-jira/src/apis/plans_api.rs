...
pub async fn create_plan(configuration: &configuration::Configuration, create_plan_request: models::CreatePlanRequest) -> Result<i64, Error<CreatePlanError>> {
    let local_var_configuration = configuration;
...
pub async fn get_plan(configuration: &configuration::Configuration, plan_id: i64) -> Result<models::GetPlanResponse, Error<GetPlanError>> {
    let local_var_configuration = configuration;
...
pub async fn update_plan(configuration: &configuration::Configuration, plan_id: i64, body: serde_json::Value) -> Result<serde_json::Value, Error<UpdatePlanError>> {
    let local_var_configuration = configuration;
